        ...
        <nav class="flex items-center justify-between mb-8">
            <div class="flex items-center gap-10">
                ...
                <div class="flex gap-8 text-gray-300">
                    ...
                    <!-- FILM -->
                    <a href="/film" class="hover:text-white transition">
                        Film
                    </a>
            ...
            <div class="flex items-center gap-4">
                <input type="text"
                    placeholder="Search"
                    class="bg-[#121212] rounded-xl px-4 py-2 outline-none">
...
>>>>>>> 1c81f3fedc06b7766df006a2e5438f3e821794c4
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-9 space-y-8">
                ...
                <!-- Hero Banner -->
                <section class="relative rounded-3xl overflow-hidden h-80 bg-gradient-to-r from-black to-gray-700 flex items-center">
...
>>>>>>> 1c81f3fedc06b7766df006a2e5438f3e821794c4
                ...
                <section>
                    ...
                    <div class="grid md:grid-cols-4 gap-4">
                        ...
                        <div class="bg-[#2a2a2a] rounded-2xl overflow-hidden shadow-lg hover:scale-105 transition-transform">
                            ...
                            <img src="{{ asset('images/film/movie'.$i.'.jpg') }}"
                                alt="Movie"
                ...
                <section>
                    ...
                    <div class="grid md:grid-cols-4 gap-4">
                        ...
                        <div class="bg-[#2a2a2a] rounded-2xl overflow-hidden shadow-lg hover:scale-105 transition-transform">
                            ...
                            <img src="{{ asset('images/rekomendasi/rekomen'.$i.'.jpg') }}"
                                alt="Movie"
                                class="w-full h-56 object-cover">
            ...
            <aside class="col-span-3 bg-[#2a2a2a] rounded-3xl p-5">
                ...
                <div class="flex gap-4 mb-6">
                    ...
                    <img src="{{ asset('images/coming/cs'.$i.'.jpg') }}"
                        alt="Coming Soon"
                        class="w-20 h-28 rounded-xl object-cover">

                    <div>
                        <h3 class="font-semibold">
                            Film Segera Tayang {{ $i }}
                        </h3>
                ...
                <button class="w-full mt-8 border border-gray-500 py-3 rounded-2xl hover:bg-white hover:text-black transition">
                    Lihat Lebih Banyak
                </button>
